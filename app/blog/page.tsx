        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            {categories.map((category) => (
              <button
                key={category}
                className="px-6 py-2 rounded-full border border-gray-300 text-gray-700 hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300"
              >
                {category}
              </button>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
              ...
              />
              <button className="bg-white text-gray-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-colors duration-300">
                Subscribe
              </button>
            </div>
          </motion.div>
